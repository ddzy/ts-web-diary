...
import { InfoWrapper, InfoMain } from "./style";
...
const ChatInterfacesViewGroupTitleInfo = React.memo(
  (props: IChatInterfacesViewGroupTitleInfoProps) => {
    const [state, setState] = React.useState<
      IChatInterfacesViewGroupTitleInfoState
    >({
      isShowDrawer: false
    });
